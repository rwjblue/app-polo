...
For Mapbox local builds, create a token with `downloads:read` scope.

For Android native builds, Gradle reads Mapbox token from your shell environment.
Export it in your terminal profile:
